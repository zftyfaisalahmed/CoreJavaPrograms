	...
	public static void main(String[] args) {
        ...
        for (int i = 0; i < n; i++) {
          ...
          //D
            ...
            // O
            for (int j = 0; j < n; j++) {
                if (j==0&&i!=0&&i!=1&&i!=2&&i<=7||i==0&&j!=0&&j!=1&&j!=2&&j<=7||j==n-1&&i!=0&&i!=1&i!=2&&i<=7||i==n-1&&j!=0&&j!=1&&j!=2&&j<=7||i+j==3||i-j==7||j-i==7||i+j==17) {
                    System.out.print("# ");
                } else {
                    System.out.print("  ");
                }
            ...
            // P
            for (int j = 0; j < n; j++) {
                if (j==0||i==0&&j!=n-1||i==n/2&&j!=n-1||j==n-1&&i!=0&i!=n/2&&i<=n/2) {
                    System.out.print("# ");
                } else {
                    System.out.print("  ");
                }
            ...
            // U
            for (int j = 0; j < n; j++) {
                if (j==0&&i<=8||j==n-1&&i<=8||i==n-1&&j>=2&&j<=8||i+j==n-1&&i>=9&&i<n-1||j-i==0&&i>=9&&i<n-1) {
                    System.out.print("# ");
                } else {
                    System.out.print("  ");
                }
